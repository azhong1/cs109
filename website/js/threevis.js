...
ThreeVis = function(_parentElement, metric, words, color){
  ...
  //append svg element
        ...
        var hello = svg.append("g")
          ...
          svg.append("g").selectAll("text").data(color_values).enter()
            .append("text")
            .attr("x", function(d, i){return (width-width*0.5)+(width*0.5/11)*i -25})
            .attr("y", height*0.07+5)
            .style("font-size", 7)
            .text(function(d) { if (isFinite(d)) return Math.round(d*10)/10; });*/
